...
import projects__api_quickTestPanelMdx from './projects__API_QuickTestPanel.mdx.json' assert { type: 'json' }
...
export const allProjects = [projects__api_quickTestPanelMdx, projects__porsche_911Mdx, projects__userApiMongoMdx, projects__vAnimeMdx, projects__mikochanMdx, projects__notesyncMdx, projects__rsahaniMdx, projects__sihVstarsMdx, projects__starRainstormMdx, projects__studyBridgeMdx]
