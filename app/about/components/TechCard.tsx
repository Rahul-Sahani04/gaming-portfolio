...
export default function TechCard({ tech }: TechCardProps) {
  ...
  return (
    <motion.div
      className="relative p-6 rounded-xl backdrop-blur-sm border border-zinc-800 bg-zinc-900/30 overflow-hidden group"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <h3 className="text-lg font-semibold mb-1 text-white">{tech.name}</h3>
