...
class AsciiFilter {
  ...
  constructor(renderer: THREE.WebGLRenderer, { fontSize, fontFamily, charset, invert, enableMouseInteraction }: AsciiFilterOptions = {}) {
...
class CanvAscii {
  ...
  constructor(
    { text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves, enableMouseInteraction }: CanvAsciiOptions,
